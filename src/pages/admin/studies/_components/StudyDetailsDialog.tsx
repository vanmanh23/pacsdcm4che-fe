...
//   const keys = Object.keys(props);
  ...
  <DialogHeader>
    <DialogTitle className="md:text-xl text-lg font-semibold">Study details</DialogTitle>
    <DialogDescription className="text-sm text-muted-foreground">
      Click the 'view instances' button to see more specific information.
    </DialogDescription>
  </DialogHeader>
  <div className="flex flex-col ">
    {Object.entries(props).map(([key, value]) => (
      ...
      >
        <div className="w-1/3 font-medium text-gray-700 capitalize">{key}</div>
  ...
  <DialogFooter className="pt-4">
    ...
    <Link  to={`/diagnosis/${props.studyInstanceUID}`}>
        <Button className="bg-bg-secondary hover:bg-bg-secondary/75 text-white">View instances</Button>
    </Link>
  </DialogFooter>
</DialogContent>
